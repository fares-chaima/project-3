...
import './Consulterbs.css'
function Consulterbs() {
...
<div className='partiebouton'>
  ...
  <button className='annuler' style={{marginLeft:'250px'}} onClick={() => history.push("/Listbs")}>retourner</button>
